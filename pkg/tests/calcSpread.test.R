...
## truth1 <- calcSpread(baseDate = "2014-01-14",
##                      currency = "USD",
##                      userCurve = TRUE,
...
## truth2 <- calcSpread(baseDate = "2014-01-14",
##                      currency = "USD",
##                      userCurve = FALSE,
...
result1 <- calcSpread(baseDate = "2014-01-14",
                      currency = "USD",
                      userCurve = TRUE,
...
result2 <- calcSpread(baseDate = "2014-01-14",
                      currency = "USD",
                      userCurve = FALSE,
