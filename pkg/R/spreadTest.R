...
calcSpread <- function(baseDate,
    ...
    .Call('calcCdsoneSpread',
          baseDate, types, dates, rates, nInstr, mmDCC, fixedSwapFreq,
          floatSwapFreq, fixedSwapDcc, floatSwapDcc, badDayConvZC, holidays,
          todayDate, valueDate, benchmarkStartDate, startDate, endDate, stepinDate,
          couponRate, payAccruedOnDefault, dateInterval, stubType,
          accrueDCC, badDayConv, calendar, upfrontCharge, recoveryRate,
          payAccruedAtStart)
}
