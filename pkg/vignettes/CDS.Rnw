...
\texttt{TDate} indicates the trade date of the CDS
contract. \texttt{maturity} is the maturity of the CDS
contract. \texttt{couponRate} is the fixed coupon of the
