...
We introduce an overview of CDS contracts and terminologies in this section.\footnote{Much of this is quoted from the appendix to \emph{The MarkIt Credit Indices Primer}, \emph{The Bloomberg Guide}, writings by Richard Newman and conversations with Neil.}
