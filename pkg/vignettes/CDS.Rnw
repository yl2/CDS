...
\begin{description}
  ...
  %%     payments, with a risk of principal impairement. Also referred to
  ...
  %%   abbrieviated to just \textbf{short}. That is, ``short CDX IG"
  %%   means buy protection on CDX IG. ``Short (or long) credit
  %%   \emph{risk}'' is also common phrasing. Another way to think about
  %%   this as being short credit ``quality''. As credit quality goes
  %%   down --- i.e., as spreads increase --- protection buyers
  %%   benefit. Example usage: ``A long CDS position corresponds to being
  %%   long protection and short credit.''
